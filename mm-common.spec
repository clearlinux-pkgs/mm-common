...
%prep
%setup -q -n mm-common-1.0.3
cd %{_builddir}/mm-common-1.0.3
...
cp %{_builddir}/mm-common-1.0.3/COPYING %{buildroot}/usr/share/package-licenses/mm-common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/mm-common-1.0.3/skeletonmm/COPYING %{buildroot}/usr/share/package-licenses/mm-common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
