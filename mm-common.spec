...
Source0  : https://download.gnome.org/sources/mm-common/1.0/mm-common-1.0.6.tar.xz
Summary  : mm-common's libstdc++ metadata module, not installed
...
%prep
%setup -q -n mm-common-1.0.6
cd %{_builddir}/mm-common-1.0.6
pushd ..
cp -a mm-common-1.0.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704732493
